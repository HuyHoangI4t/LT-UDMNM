                ...
                <div id="header-carousel" className="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img className="img-fluid w-100" src="https://tuyensinh.ttn.edu.vn/wp-content/uploads/2023/02/banner-7.jpg" alt="Banner 1" />
                        </div>
                        <div className="carousel-item">
                            <img className="img-fluid w-100" src="https://tuyensinh.ttn.edu.vn/wp-content/uploads/2026/04/3160-CHI-TIEU.png" alt="Banner 2" />
                        </div>
                        <div className="carousel-item">
                            <img className="img-fluid w-100" src="https://tuyensinh.ttn.edu.vn/wp-content/uploads/2024/01/banner-4.jpg" alt="Banner 3" />
                        </div>
                        <div className="carousel-item">
                            <img className="img-fluid w-100" src="https://tuyensinh.ttn.edu.vn/wp-content/uploads/2023/02/banner-6.jpg" alt="Banner 4" />
                        </div>
                        <div className="carousel-item">
                            <img className="img-fluid w-100" src="https://tuyensinh.ttn.edu.vn/wp-content/uploads/2024/02/B101.jpg" alt="Banner 5" />
                        </div>
                    </div>
